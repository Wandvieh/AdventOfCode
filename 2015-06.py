...
with open('2015-06.txt', 'r') as f:  
    input = f.read().split('\n')

"""lights = np.array([[False]*1000]*1000)

for line in input:
    instruction = re.findall("\D+", line)[0].strip()
